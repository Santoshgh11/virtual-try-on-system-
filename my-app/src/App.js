...
// import ScanPage from './pages/ScanPage';
// import ResultPage from './pages/ResultPage';
// import AiRecommendations from './pages/AiRecommendations'; // ✅ Added AI Recommendations Page
// import SuggestionsPage from './pages/SuggestionsPage'; // ✅ Added Suggestions Page
...
//                 <Route path="/result" element={<ResultPage />} />
//                 <Route path="/3d-model" element={<ThreeJSVisualization />} />
//                 <Route path="/ai-recommendations" element={<AiRecommendations />} /> {/* ✅ Added AI Recommendations Page */}
//                 <Route path="/suggestions" element={<SuggestionsPage />} /> {/* ✅ Added Suggestions Page */}
//             </Routes>
//         </Router>
//     );
// }
